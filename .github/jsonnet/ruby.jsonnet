{
  rubyDeployPRPipeline(serviceName,
    ...
    $.pipeline('deploy-pr',
      [
        $.ghJob('deploy-pr',
          image = $.default_rails_step_image,
          steps = [
  ...
  deployApiDocs(serviceName,
    ...
    $.ghJob('apidocs',
      ...
      steps=[
        ...
        $.action('setup auth', 'google-github-actions/auth@v0',
          with={
  ...
  rubyDeletePRPipeline(serviceName,
    options = {},
